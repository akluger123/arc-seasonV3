...
// One type family (system default) carrying the whole app; personality
// comes from weight and scale rather than a second display face, which
// keeps small screens (this is a phone-first habit tracker) legible.
